...
const Navbar = ({ onCategoryChange}) => {
  ...
  const [isCategoryDropdownVisible, setIsCategoryDropdownVisible] = useState(false); // New state for the category dropdown
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex ">
            ...
            >
              ...
              <span className="sr-only"> {selectedCategory !== 'All' ? selectedCategory : 'Search'}</span>
            </button>
            <div className="relative hidden md:block" onClick={handleCategoryDropdownHover} >
          ...
          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
            ...
            <input
              type="text"
              id="search-navbar"
              className="block w-full lg:w-[170%] p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Search..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            {isCategoryDropdownVisible && ( // Display the category dropdown when isCategoryDropdownVisible is true
              <div className="absolute mt-2 space-y-2 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-700">
                <button
